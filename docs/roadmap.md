...
| **Consensus Commons** (experimental) | Bitcoin++ Toronto MVP: Zaprite sandbox reconciliation, Wavelength signet payments, OpenTimestamps consensus receipts, one-time 210 signet-sat rewards, booking chat, manual refund cases, OpenStays Mail, and consensus timeline. Not production rails. |
