...
export type OperationalActionName =
  ...
  | 'front-desk/flag/create'
  | 'front-desk/flag/assign'
  | 'front-desk/flag/resolve'
  | 'housekeeping/assign'
  | 'housekeeping/state'
  | 'housekeeping/assignment/update'
  | 'housekeeping/assignment/start'
  | 'housekeeping/checklist/item'
  | 'housekeeping/inspection/submit'
  | 'housekeeping/inspection/review'
  | 'housekeeping/assignment/cancel'
  | 'maintenance/resolve'
  | 'folios/retail'
  | 'folios/entry'
  | 'folios/reverse'
