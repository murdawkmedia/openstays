...
export const PUBLIC_OPERATIONS_FIXTURE: PublicOperationsFixture = {
  ...
  records: [
    ...
    },
    {
      ...
      details: [
        { label: 'Reservation state', value: 'Checked in · unchanged' },
        { label: 'Inventory', value: 'Stay dates remain authoritative' },
        { label: 'Action', value: 'Desk follow-up assigned' },
      ],
    },
    {
      id: 'demo-front-desk-overdue',
      kind: 'front_desk',
      title: 'Departure overdue',
      status: 'Urgent · needs attention',
      summary: 'A fictional departure passed its expected time and is visible in the attention queue.',
      updatedLabel: '12 min ago',
      details: [
        { label: 'Escalation', value: 'Front-desk manager alerted' },
        { label: 'Occupancy', value: 'Current reservation remains authoritative' },
        { label: 'Next step', value: 'Contact attempt and resolution note' },
      ],
    },
    {
      id: 'demo-housekeeping-turnover',
      kind: 'housekeeping',
      title: 'Turnover checklist',
      status: '4 of 6 complete',
      summary: 'A fictional turnover uses an immutable checklist snapshot assigned for today’s work.',
      updatedLabel: '5 min ago',
      details: [
        { label: 'Cleaning type', value: 'Turnover' },
        { label: 'Progress', value: 'Two required steps remain' },
        { label: 'Readiness', value: 'Cleaning · not yet ready' },
      ],
    },
    {
      id: 'demo-housekeeping-correction',
      kind: 'housekeeping',
      title: 'Inspection correction',
      status: 'Returned to cleaning',
      summary: 'A fictional inspection failed with a reason and returned the same assignment for correction.',
      updatedLabel: '4 min ago',
      details: [
        { label: 'Inspection', value: 'Correction required' },
        { label: 'Service state', value: 'Cleaning' },
        { label: 'Audit', value: 'Reviewer and reason recorded' },
      ],
    },
    {
      id: 'demo-housekeeping-ready',
      kind: 'housekeeping',
      title: 'Verified ready unit',
      status: 'Ready',
      summary: 'A fictional manager passed inspection after every required checklist item was complete.',
      updatedLabel: '1 min ago',
      details: [
        { label: 'Checklist', value: 'All required work complete' },
        { label: 'Inspection', value: 'Passed by manager role' },
        { label: 'Sellability', value: 'Unchanged by service readiness' },
      ],
    },
    {
